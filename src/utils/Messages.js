...
export const CommonSuccessMessages = {
	...
	Accept_Question: 'Accept {0}?',
	Confirm_Accept: 'Are you sure you want to accept this {0}?',
	Reject_Question: 'Reject {0}?',
	Confirm_Reject: 'Are you sure you want to reject this {0}?',
	Confirm_Question_Approve: 'Approve {0}?',
	Confirm_Approve: 'Are you sure you want to approve this {0}?',
